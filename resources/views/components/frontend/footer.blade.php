<footer class="section-footer border-top">
    <div class="container">
        <section class="footer-top padding-y">
            <div class="row">
                ...
                <aside class="col-sm-2  col-md-2">
                    ...
                    <a href="#" class="d-block mb-2"><img src={{ asset('frontend/images/misc/appstore.png') }}
                            height="40"></a>
                    <a href="#" class="d-block mb-2"><img src={{ asset('frontend/images/misc/playmarket.png') }}
                            height="40"></a>
                </aside>
            </div>
        </section>
        ...
        <section class="footer-copyright border-top">
            ...
            <p class="text-muted"> &copy 2022 Agribilis. All rights reserved </p>
