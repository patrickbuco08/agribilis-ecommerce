        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Type here" class="form-control @error('name') is-invalid @enderror">
                    </div>
                    <div class="mb-4">
                        <label class="form-label">Description</label>
                        <textarea placeholder="Type here" name="description" class="form-control @error('description') is-invalid @enderror" rows="4">{{old('description')}}</textarea>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <div class="row">
                            ...
                            <label class="form-label">Unit</label>
                                <input type="text" name="unit" value="{{ old('unit') }}" placeholder="Type here" class="form-control @error('unit') is-invalid @enderror">
                            </div>
                            <div class="col-6">
                            <label class="form-label">Stock</label>
                                <input type="text" name="stock" value="{{ old('stock') }}" placeholder="Type here" class="form-control @error('stock') is-invalid @enderror">
                            </div>
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <select class="form-select @error('delivery_min') is-invalid @enderror" name="delivery_min">
                                    ...
                                    <option value="1" @if(old('delivery_min') == 1) selected @endif> 1 </option>
                                    <option value="2" @if(old('delivery_min') == 2) selected @endif> 2 </option>
                                    <option value="3" @if(old('delivery_min') == 3) selected @endif> 3 </option>
                                    <option value="4" @if(old('delivery_min') == 4) selected @endif> 4 </option>
                                    <option value="5" @if(old('delivery_min') == 5) selected @endif> 5 </option>
                                    <option value="6" @if(old('delivery_min') == 6) selected @endif> 6 </option>
                                    <option value="7" @if(old('delivery_min') == 7) selected @endif> 7 </option>
                                    <option value="8" @if(old('delivery_min') == 8) selected @endif> 8 </option>
                                    <option value="9" @if(old('delivery_min') == 9) selected @endif> 9 </option>
                                    <option value="10" @if(old('delivery_min') == 10) selected @endif> 10 </option>
                                </select>
                            </div>
                            <div class="col-6">
                                ...
                                <select class="form-select" name="delivery_max">
                                    ...
                                    <option value="2" @if(old('delivery_max') == 2) selected @endif> 2 </option>
                                    <option value="3" @if(old('delivery_max') == 3) selected @endif> 3 </option>
                                    <option value="4" @if(old('delivery_max') == 4) selected @endif> 4 </option>
                                    <option value="5" @if(old('delivery_max') == 5) selected @endif> 5 </option>
                                    <option value="6" @if(old('delivery_max') == 6) selected @endif> 6 </option>
                                    <option value="7" @if(old('delivery_max') == 7) selected @endif> 7 </option>
                                    <option value="8" @if(old('delivery_max') == 8) selected @endif> 8 </option>
                                    <option value="9" @if(old('delivery_max') == 9) selected @endif> 9 </option>
                                    <option value="10" @if(old('delivery_max') == 10) selected @endif> 10 </option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <input type="text" name="price" value="{{ old('price') }}" placeholder="00.0" class="form-control @error('price') is-invalid @enderror">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="mb-4">
                        ...
                        <label class="mb-2 form-check form-check-inline" style="width: 45%;">
                            <input class="form-check-input  @error('category_id') is-invalid @enderror" @if(old('category_id') == $category->id) checked @endif name="category_id" value="{{ $category->id }}" type="radio">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row" id="product-preview"></div>
                    <script>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">Save and activate </button>
            </div>
        </form>
        </div>
    </div>
